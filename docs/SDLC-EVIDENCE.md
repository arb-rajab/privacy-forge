...
| 3. Architecture & Design | baseline | System context/container diagrams, 3 sequence diagrams, ERD, validated OpenAPI 3.1 spec, 5 ADRs | `docs/project-memory/03-architecture.md`, `04-data-model.md`, `05-api-contracts.md`, `docs/adr/`, `docs/architecture/openapi.yaml` |
